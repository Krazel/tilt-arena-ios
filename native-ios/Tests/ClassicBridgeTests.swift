...
final class ClassicBridgeTests: XCTestCase {
    func testHardModeBridgeOpeningAndSeparateRecords() throws {
        ...
        XCTAssertEqual(hard.mode, "hard"); XCTAssertTrue((3...5).contains(hard.enemies.count))
    ...
    func testNewPowersAndLongRangeElectricityDecodeAndHaveDistinctNativeArt() throws {
        ...
        XCTAssertEqual(recaught.player.boomerangChargeProgress, 0.5, accuracy: 0.0001)
        XCTAssertEqual(recaught.score, 10)
